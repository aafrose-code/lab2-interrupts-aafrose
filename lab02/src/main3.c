...
void init_systick() {
    //To find load value, it is important to find the Hz per row and the amount of seconds it takes to scan per row
    //It takes 0.0625 s to scan a row once (1/4 = 0/25/4 = 0.0625)
    //48 mHz = 48000000 Hz
    //8 rows so: 48000000/8 = 6000000 Hz per row
    //6000000 * 0.0625 = 375000
    //Writing a value that is 1 less than the effective value, so 374999 
    SysTick->LOAD = 374999;
    SysTick->VAL = 0;//Initializing SysTick->VAL to 0
    SysTick->CTRL = SysTick_CTRL_TICKINT_Msk | SysTick_CTRL_ENABLE_Msk;//turning on tickint and enable bit through OR operator
}